...
#   curl -fsSL https://raw.githubusercontent.com/hidoos/claude-code-switch/main/quick-install.sh | bash
#
# Features:
...
# Configuration
GITHUB_REPO="${GITHUB_REPO:-hidoos/claude-code-switch}"
...
For more info: https://github.com/hidoos/claude-code-switch
EOF
}
